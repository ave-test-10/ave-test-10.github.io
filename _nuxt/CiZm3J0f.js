...
`;var W=function(t,r,e,a){var o,i=arguments.length,n=i<3?r:null===a?a=Object.getOwnPropertyDescriptor(r,e):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,r,e,a);else for(var s=t.length-1;s>=0;s--)(o=t[s])&&(n=(i<3?o(n):i>3?o(r,e,n):o(r,e))||n);return i>3&&n&&Object.defineProperty(r,e,n),n};let q=class extends r{constructor(){super(...arguments),this.variant="main",this.size="lg"}render(){this.dataset.variant=this.variant,this.dataset.size=this.size;const t="md"===this.size?"mini-700":"micro-700";return e`
    ...
    `}};q.styles=[g,U],W([i()],q.prototype,"variant",void 0),W([i()],q.prototype,"size",void 0),q=W([w("wui-tag")],q);const X=t`
  :host {
    display: flex;
  }
...
`;var K=function(t,r,e,a){var o,i=arguments.length,n=i<3?r:null===a?a=Object.getOwnPropertyDescriptor(r,e):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,r,e,a);else for(var s=t.length-1;s>=0;s--)(o=t[s])&&(n=(i<3?o(n):i>3?o(r,e,n):o(r,e))||n);return i>3&&n&&Object.defineProperty(r,e,n),n};let Z=class extends r{constructor(){super(...arguments),this.color="accent-100",this.size="lg"}render(){return this.style.cssText="--local-color: "+("inherit"===this.color?"inherit":`var(--wui-color-${this.color})`),this.dataset.size=this.size,e`<svg viewBox="25 25 50 50">
    ...
    </svg>`}};Z.styles=[g,X],K([i()],Z.prototype,"color",void 0),K([i()],Z.prototype,"size",void 0),Z=K([w("wui-loading-spinner")],Z);export{v as U,w as c,R as f,y as o};
