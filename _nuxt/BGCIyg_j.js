...
`;var F=function(t,r,e,a){var o,i=arguments.length,n=i<3?r:null===a?a=Object.getOwnPropertyDescriptor(r,e):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,r,e,a);else for(var s=t.length-1;s>=0;s--)(o=t[s])&&(n=(i<3?o(n):i>3?o(r,e,n):o(r,e))||n);return i>3&&n&&Object.defineProperty(r,e,n),n};let U=class extends r{constructor(){super(...arguments),this.src="./path/to/image.jpg",this.alt="Image",this.size=void 0}render(){return this.style.cssText=`\n      --local-width: ${this.size?`var(--wui-icon-size-${this.size});`:"100%"};\n      --local-height: ${this.size?`var(--wui-icon-size-${this.size});`:"100%"};\n      `,e`<img src=${this.src} alt=${this.alt} @error=${this.handleImageError} />`}handleImageError(){this.dispatchEvent(new CustomEvent("onLoadError",{bubbles:!0,composed:!0}))}};U.styles=[g,p,G],F([i()],U.prototype,"src",void 0),F([i()],U.prototype,"alt",void 0),F([i()],U.prototype,"size",void 0),U=F([w("wui-image")],U);const Y=t`
  :host {
    display: flex;
    justify-content: center;
    align-items: center;
...
`;var K=function(t,r,e,a){var o,i=arguments.length,n=i<3?r:null===a?a=Object.getOwnPropertyDescriptor(r,e):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,r,e,a);else for(var s=t.length-1;s>=0;s--)(o=t[s])&&(n=(i<3?o(n):i>3?o(r,e,n):o(r,e))||n);return i>3&&n&&Object.defineProperty(r,e,n),n};let X=class extends r{constructor(){super(...arguments),this.color="accent-100",this.size="lg"}render(){return this.style.cssText="--local-color: "+("inherit"===this.color?"inherit":`var(--wui-color-${this.color})`),this.dataset.size=this.size,e`<svg viewBox="25 25 50 50">
    ...
    </svg>`}};X.styles=[g,Q],K([i()],X.prototype,"color",void 0),K([i()],X.prototype,"size",void 0),X=K([w("wui-loading-spinner")],X);export{v as U,w as c,R as f,y as o};
